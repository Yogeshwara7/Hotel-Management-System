...
<head>
    ...
    <title>Delete Reservation - Luxury Hotel</title>
...
<body>
    ...
    <div class="container" style="margin-top: 6rem;">
        <h2 class="text-center mb-4">Delete Reservation</h2>
        ...
        <div class="form-container">
            ...
            <form action="DeleteReservationServlet" method="post" class="form-container">
